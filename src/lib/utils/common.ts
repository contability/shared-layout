import { TInferParser, TParser } from "../../types/Parser";
...
/**
 *
 * @param params {URLSearchParams} URLSearchParams 객체
 * @param key {string} 추가할 param의 key
 * @param value {string} 추가할 param의 value
 */
export const appendValidParam = (
...
/**
 * @param obj 데이터
 * @returns 데이터의 값이 없는 필드는 제거하여 반환
 */
export const convertValidationObjectValue = (
