  ...
  return (
    <>
      ...
      <div className="flex space-x-4 mb-6">
        <div className="w-12 h-12 bg-gray-200 rounded-full shrink-0 animate-shimmer" />
    ...
    <div className="space-y-6">
      ...
      <div className={`space-y-6 ${isLoading ? "hidden" : "block"}`}>
        ...
        <div className="space-y-3 mb-6">
          ...
          <p className="text-gray-400">컴포넌트 기반 설계의 기본 원칙</p>
          <p className="text-gray-400">재사용성과 유지보수성을 고려한 개발</p>
          <p className="text-gray-400">2025년 03월 24일 작성</p>
        </div>
        ...
        <div className="space-y-3">
          <p className="text-gray-200">
            React 컴포넌트를 설계할 때는 단일 책임 원칙을 준수해야 합니다. 각
            컴포넌트는 하나의 명확한 목적을 가져야 하며, 재사용 가능한 형태로
            설계되어야 합니다.
          </p>
          <p className="text-gray-200">
            컴포넌트의 props는 명확하게 정의되어야 하며, 필요한 경우 타입 검사를
            통해 안정성을 확보할 수 있습니다.
          </p>
          <p className="text-gray-200">
            스타일링은 CSS-in-JS나 CSS 모듈을 사용하여 컴포넌트와 함께 관리하는
            것이 좋습니다.
          </p>
        </div>
      </div>
